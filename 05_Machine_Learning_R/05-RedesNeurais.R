...
# Analisando dados das casas de Boston, nos EUA e fazendo previsoes


# The Boston Housing Dataset
# http://www.cs.toronto.edu/~delve/data/boston/bostonDetail.html

# Prevendo a MEDV (Valor da Mediana de ocupação das casas)
...
# Fazendo previsoes com dados de teste
