...
# Verificando e definindo o diretorio de trabalho
getwd()
setwd("C:/Projetos/Git_Projetos/BD_Analytics_com_R/05_Machine_Learning_R")

# carregando o pacote readr
library(readr)

# Carregando o dataser
...
boxplot(carros$preco, main = "Boxplot para os precos de carros udados", ylab = "Preco (R$)")
boxplot(carros$kilometragem, main = "Boxplot para Km de carros Usados", ylab = "kilometragem")

# Histograma
# Indicam a frequencia de valores dentro de cada bin (classe de valores)
hist(carros$preco, main = "Histograma para os precos de carros usados", ylab = "Preço (R$)")
hist(carros$kilometragem, main = "Histograma para Km de Carros Usados", ylab = "Kilometragem")
hist(carros$kilometragem, main = "Histograma para Km de Carros Usados", breaks = 5, ylab = "Kilometragem")

# Scatterplot preco X km
# Usando o preço como varial dependente (y)
...
# Criando tabelas de contigencia - representam uma unica variavel categorica
...
# Qui Quadrado, simbolizado por ??2 eh um teste de 
