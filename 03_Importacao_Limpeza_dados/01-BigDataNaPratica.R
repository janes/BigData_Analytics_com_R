...
# Download e unzip do arquivo (Exemplo de quando for necessário)
# url <- "http://url/crimes.zip"
# arquivo <- "crimes.zip"
# download(url, arquivo)
# teremos o arquivo no caminho do diretório
# unzip("crimes.zip")
...
map.paris +
  ...
  scale_color_gradient(low = "#33CC33", high = "#003300", name = "Número de Bikes Dispinível") + 
